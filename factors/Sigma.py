...
#     period_dict_l[period[0]] = (reg_start_id, reg_end_id)
#
# # Fama-French regression is performed for each stock for 120 days
# rw_l = RollingWindow(rets, factors, group_by=period_dict_l, nan_num=5)
# result = rw_l.regress('group')
#
#
...
# res = rw_l.read_result(get_ssr).T
